# Code Description
The `taxicab_problem.cpp` file contains the implementation of two main methods to calculate Taxicab numbers, which are integers that can be expressed as the sum of cubes of two pairs of positive integers in two different ways. A famous example is the number 1729, known as the Hardy-Ramanujan number.
